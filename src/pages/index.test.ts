...
const confirmedOrder = ['ReviewsReel', 'Guarantee', 'Faq', 'ResultsGallery', 'SiteFooter'] as const;
...
describe('landing sections after customer reviews', () => {
  ...
  it('keeps Reviews, Guarantee, FAQ, Results Gallery, and Footer in the confirmed order', () => {
